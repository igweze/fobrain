...
?>
			...
			<!-- form -->
			<form class="form-horizontal mb-70" id="frmsaveHomeWork" role="form">			
				...
				<div class="row gutters">
					<div class="col-12">										
						...
						<div class="field-wrapper select-wrapper">
							...
							<input type="hidden" value="saveHomeWork" name = "homework"/>
				...
				<div id="subjectExamDiv" style="display:none;">   
					...
					<div class="row gutters">
						<div class="col-12">										
							...
							<div class="field-wrapper">
								...
								placeholder="Enter Home work Instructions"></textarea>
					...
					<div class="row gutters mt-30">
						<div class="col-12 text-end"> 
							...
							btn-label waves-light" id="saveHomeWork">
