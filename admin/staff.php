...
if(!session_id()){
    session_start();
		...
		|| ($_SESSION['accessGrade'] != $staff_fobrain_grd)
		|| (!isset($_SESSION['accessLevel']))
		|| ($_SESSION['accessLevel'] != $staff_fob_tagged)
                    ...
                    <div id="sidebar-menu"> 
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu"> 
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">     
                                    <li class="wiz-menu"><a  href="javascript:;" id="upload-results">
                                        <i class="mdi mdi-chevron-right"></i> Upload Result </a>
                                    </li> 
