						...
						if($onlineExamDataCount >= $fiVal){  /* check array is empty */	 		
							...
							for($i = $fiVal; $i <= $onlineExamDataCount; $i++){  /* loop array */		
								...
								if($status == 0){
									...
									$exam_btn = '<a href="javascript:;"  class ="text-sienna btn waves-effect btn-label waves-light">
									...
									<td>  
										<div class="btn-group">
											...
											<div class="dropdown-menu dropdown-menu-lg-end p-10 dropdown-shadow end-0 animate__animated animate__flipInY"> 
												...
												<p class="mb-10">
													<a href='javascript:;' id='fobrain-$eID' class ='addExamQuest text-primary btn waves-effect btn-label waves-light'>									
														<i class="mdi mdi-progress-question label-icon"></i> Questions
													</a>	
												</p>
												<p class="mb-10">
													<a href='javascript:;' id='$eID' class ='view-exam text-sienna btn waves-effect btn-label waves-light'>									
														<i class="mdi mdi-text-box-search label-icon"></i> View 
													</a>	
												</p>
												<p class="mb-10">
													<a href='javascript:;' id='$eID' class ='edit-exam text-slateblue btn waves-effect btn-label waves-light'>									
														<i class="mdi mdi-square-edit-outline label-icon"></i> Edit
													</a>	
												</p>
												<p>
													<a href='javascript:;' id='fobrain-$eID-$eTitle' class ='remove-exam demo-disenable text-danger btn waves-effect btn-label waves-light'>									
