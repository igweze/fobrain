...
if(!session_id()){
    session_start();
		...
		$show_comp_wall = true; require_once ($fobrainCWallFunctionDir);	  /* load companion functions */	

		if ( (!isset($_SESSION['accessGrade']))
		|| ($_SESSION['accessGrade'] != $admin_fobrain_grd)
		|| (!isset($_SESSION['accessLevel']))
		|| ($_SESSION['accessLevel'] != $admin_tagged)
		...
		try {  
            ...
            if($can_use_search == true){ 
			    $activeStudent = activeStudentOptions($conn);  /* students token record information  */
            } 
...
<div class="app_settings">
    <a href="javascript:void(0);" class="switch-btn"><i class="fa fa-cogs"></i></a>
    <div class="app_preset">
        <h4>Choose color skin</h4>
                ...
                <div data-simplebar class="h-100"> 
                    ...
                    <div id="sidebar-menu"> 
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu"> 
							...
							<li data-title="FoBrain Page Tour" data-intro="This School Section settings here 👋">
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i class="mdi mdi-database-cog"></i>
                                    <span><?php //echo $schoolTypeSD; ?> School Settings</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">  
                                     
									<li class="wiz-menu-2">
                                        <a  class="tpMenu"  href="javascript:;" id="exam-config">
										    <i class="mdi mdi-chevron-right"></i> Exam Config.
                                        </a>
									</li>
									<li class="wiz-menu-2">
                                            <a  class="tpMenu"  href="javascript:;" id="min-course-config">
										        <i class="mdi mdi-chevron-right"></i> Exam Min. Course
                                            </a>
									</li>
										<li class="wiz-menu-2">
                                            <a  class="tpMenu"  href="javascript:;" id="levels-config">
										        <i class="mdi mdi-chevron-right"></i> Level Config.
                                            </a>
									</li>
										<li class="wiz-menu-2">
                                            <a  class="tpMenu"  href="javascript:;" id="class-config">
										        <i class="mdi mdi-chevron-right"></i> Class Config.
                                            </a> 
									</li>				  
										
									<li class="sub-menu">
										<a  href="javascript:;"><i class="mdi mdi-chevron-right"></i> Add/Edit Courses </a>
										<ul class="sub-menu" aria-expanded="true">

											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="subjects-1"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                <span id="wiz-menu-l-1"><?php echo  $levelArrConf[$fiVal]['level']; ?></span> Level</a>
											</li>
											
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="subjects-2"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                <span id="wiz-menu-l-2"><?php echo  $levelArrConf[$seVal]['level']; ?></span>  Level</a>
											</li>
											
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="subjects-3"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                <span id="wiz-menu-l-3"><?php echo  $levelArrConf[$thVal]['level']; ?></span> Level</a>
											</li>
											
											<?php  if($schoolExt != $fobrainNurAbr){  /* check if not nusery school */  ?> 
											
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="subjects-4"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                <span id="wiz-menu-l-4"><?php echo  $levelArrConf[$foVal]['level']; ?></span> Level</a>
											</li>
											
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="subjects-5"> 
												<i class="mdi mdi-chevron-right"></i>  
                                                <span id="wiz-menu-l-5"><?php echo  $levelArrConf[$fifVal]['level']; ?></span> Level</a>
											</li>
											
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="subjects-6"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                <span id="wiz-menu-l-6"><?php echo  $levelArrConf[$sixVal]['level']; ?></span> Level</a>
											</li>  
											<?php } ?>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">     
                                    ...
                                    <li class="wiz-menu"><a  href="javascript:;" id="assign-class">
                                        <i class="mdi mdi-chevron-right"></i>  Assign Class</a>
                                    </li>
                                    ...
                                    <li class="wiz-menu-1"><a  href="javascript:;" id="staff-sms">
                                        <i class="mdi mdi-chevron-right"></i> Send SMS</a>
                                    </li>
                                    <li class="wiz-menu-1"><a  href="javascript:;" id="staff-mail">
                                        <i class="mdi mdi-chevron-right"></i> Send Email</a>
                                    </li>                                        
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">     
                                    <li class="wiz-menu"><a  href="javascript:;" id="create-student">
                                        <i class="mdi mdi-chevron-right"></i> Create Student </a>
                                    </li> 
                                    <li class="wiz-menu"><a  href="javascript:;" id="create-bulk-bio">
                                        <i class="mdi mdi-chevron-right"></i> Bulk Upload</a>
                                    </li>                                      
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">     
                                    <li class="sub-menu">
										...
										<ul class="sub-menu" aria-expanded="true"> 
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="upload-results"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                Manual Input</a>
											</li> 
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="upload-results-bulk"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                Bulk Upload</a>
											</li> 
										</ul>
                                    ...
                                    <li class="wiz-menu"><a  href="javascript:;" id="transcripts">
                                        <i class="mdi mdi-chevron-right"></i> Transcript </a>
                                    </li>   
                                    <li class="sub-menu">
										<a  href="javascript:;"><i class="mdi mdi-chevron-right"></i> Export Result </a>
										<ul class="sub-menu" aria-expanded="true"> 
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="export-result"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                Comp. Result</a>
											</li> 
											<li class="wiz-menu"><a  class="tpMenu"  href="javascript:;" id="export-comm-rs"> 
												<i class="mdi mdi-chevron-right"></i> 
                                                Comment Result</a>
											</li> 
										</ul>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">     
                                    <li class="wiz-menu"><a  href="javascript:;" id="sms-student">
                                        <i class="mdi mdi-chevron-right"></i> Student/Guardian</a>
                                    </li>
                                    <li class="wiz-menu"><a  href="javascript:;" id="staff-sms">
                                        <i class="mdi mdi-chevron-right"></i>  Staffs</a>
                                    </li>
                                    <li class="wiz-menu-1"><a  href="javascript:;" id="sms-config">
                                        <i class="mdi mdi-chevron-right"></i>  Config. SMS</a>
                                    </li>                                 
                                </ul>
                            </li>  
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">     
                                    <li class="wiz-menu"><a  href="javascript:;" id="mail-student">
                                        <i class="mdi mdi-chevron-right"></i> Student/Guardian</a>
                                    </li>
                                    <li class="wiz-menu"><a  href="javascript:;" id="staff-mail">
                                        <i class="mdi mdi-chevron-right"></i>  Staffs</a>
                                    </li>
                                    <li class="wiz-menu-1"><a  href="javascript:;" id="mail-config">
                                        <i class="mdi mdi-chevron-right"></i>  Config. Mail</a>
                                    </li>                                 
                                </ul>
                            </li>
