...
/* 
	...
	-------- Script Description --------
	This script handle student home work
	------------------------------------------------------------------------*/
    ...
    session_start();
     ...
     define('fobrain', 'igweze');  /* define a check for wrong access of file */
        ...
        require 'fobrain-config.php';  /* load fobrain configuration files */
			...
			if ($_REQUEST['homework'] == 'saveHomeWork') {  /* save homework */
				...
				if ($session == "")  {
					...
					$msg_e = "* Ooops Error, please select target homework class";
					echo $errorMsg.$msg_e.$eEnd; 
					echo "<script type='text/javascript'>   hidePageLoader(); </script>";exit;
					
	   			}elseif ($level == "")  {
         			
					$msg_e = "* Ooops Error, please enter target homework level";
					echo $errorMsg.$msg_e.$eEnd; 
					echo "<script type='text/javascript'>   hidePageLoader(); </script>";exit;
					...
					$msg_e = "* Ooops Error, please select target homework term";
					echo $errorMsg.$msg_e.$eEnd; 
					echo "<script type='text/javascript'>   hidePageLoader(); </script>";exit;
					
	   			}elseif ($eTitle == "")  {
         			
					$msg_e = "* Ooops Error, please enter homework title";
					echo $errorMsg.$msg_e.$eEnd; 
					echo "<script type='text/javascript'>   hidePageLoader(); </script>";exit;
					
	   			}elseif ($eSubject == "")  {
         			
					$msg_e = "* Ooops Error, please select homework subject";
					echo $errorMsg.$msg_e.$eEnd; 
					echo "<script type='text/javascript'>   hidePageLoader(); </script>";exit;
					
	   			}elseif ($eTime == "")  {
         			
					$msg_e = "* Ooops Error, please enter homework duration";
					echo $errorMsg.$msg_e.$eEnd; 
					echo "<script type='text/javascript'>   hidePageLoader(); </script>";exit;
				...
				/*elseif ($eDetail == "")  {
					...
					$msg_e = "* Ooops Error, please enter homework instruction";
					echo $errorMsg.$msg_e.$eEnd; 
				...
				*/
					...
					$eDetail = "";	
		 			...
		 			try {
						...
						$ebele_mark = "INSERT INTO $fobrainHomeWorkTB  (session, level, class, eTerm, eTitle, eSubject, eTime, eDetail, eGrade, eStaff, status)
						...
						if($igweze_prep->execute()){  /* if sucessfully */ 
							...
							$eID = $conn->lastInsertId($fobrainHomeWorkTB);
							...
							$eDetailS = nl2br($eDetailS); 
							 ...
							 <tr>
                                    <th class="text-left" width="20%"> Home work Instruction/s </th>
							...
							<div class="row gutters row-section fobrain-section-div justify-content-center">
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 table-responsive">	
									...
									<tbody>
										<tr>
											<th> Target Class </th>
											<td>$session - $sessionS Session   $homeworkLevel $class</td>
...
IGWEZE;
							...
							require_once 'e-hm-questions-info.php';  /* include assignment question div */
							echo"</div> 
							...
							$msg_s = "e Home work information was successfully created"; 
							echo $succesMsg.$msg_s.$sEnd;   

							echo "<script type='text/javascript'>  
									$('.head-quest').fadeIn(100);
									$('.head-homework').fadeOut(100); 
									$('.view-info-div').fadeIn(1000);
									$('.add-new-div').fadeOut(1000);
									$('.load-wiz-frm, #subjectHomeWorkDiv').fadeOut(1000);
									$('.new-homework-div').fadeIn(1000);
									$('#frmsaveHomeWork')[0].reset();
							...
							$msg_e =  "Ooops, an error has occur while to create new e Home work information. Please try again";
							echo $errorMsg.$msg_e.$eEnd; 
							echo "<script type='text/javascript'>   hidePageLoader(); </script>";exit;
			...
			}elseif ($_REQUEST['homework'] == 'update') {  /* update homework */
				...
				*/
					...
					*/
					$eDetail = ""; 
		 			...
		 			try { 
						...
						$ebele_mark = "UPDATE $fobrainHomeWorkTB  
						...
						if($igweze_prep->execute()){  /* if sucessfully */
							...
							$msg_s = "e Home work information was successfully saved."; 
							echo $succesMsg.$msg_s.$sEnd; 
							echo "<script type='text/javascript'> 
									$('#load-wiz-info').load('e-homework-info.php'); 
									//$('#frmupdateHomeWork').slideUp(1500);
							...
							$msg_e =  "Ooops, an error has occur while to save e Home work information. 
							Please try again";
							echo $errorMsg.$msg_e.$eEnd; 
							echo "<script type='text/javascript'> hidePageLoader(); </script>";exit;
			...
			}elseif ($_REQUEST['homework'] == 'questions') {  /* save homework question */
				...
				if ($eID == ""){
					...
					$msg_e = "* Ooops, an error has occur while to retrieve homework information. Please try again";
					echo $errorMsg.$msg_e.$eEnd; 
					echo "<script type='text/javascript'>   hidePageLoader(); </script>";exit;
		 			...
		 			try { 
						...
						$sessionID = $onlineHomeWorkInfoArr[$i]["session"];
						$level = $onlineHomeWorkInfoArr[$i]["level"];
						$eTerm = $onlineHomeWorkInfoArr[$i]["eTerm"];
						$class = $onlineHomeWorkInfoArr[$i]["class"];
						$eTitle = $onlineHomeWorkInfoArr[$i]["eTitle"];
						$eSubject = $onlineHomeWorkInfoArr[$i]["eSubject"];
						$eDetail = htmlspecialchars_decode($onlineHomeWorkInfoArr[$i]["eDetail"]);
						$eTime = $onlineHomeWorkInfoArr[$i]["eTime"];
...
IGWEZE;
			...
			}elseif ($_REQUEST['homework'] == 'removeHomeWork') {  /* remove homework */

				
				$homework = $_REQUEST['eData'];
				
				list($fobrainIg, $eID, $hName) = explode("-", $homework);			
				
				/* script validation */ 
				
				if (($homework == "")  || ($eID == "")){
         			
					$msg_e = "* Ooops, an error has occur while to remove homework information. Please try again";
					echo $errorMsg.$msg_e.$eEnd; 
			...
			}elseif ($_REQUEST['homework'] == 'view') {  /* view homework */
				...
				if ($eID == ""){
					...
					echo "<script type='text/javascript'> hidePageLoader(); </script>";exit;
		 			...
		 			try {
						...
						/*<tr><th>
							<i class="fa fa-sort-alpha-asc"></i> Home work Details </td> <td>
							$eDetail</td> </tr>
						*/	
...
$showHomeWork =<<<IGWEZE
						...
						<div id = 'fobrain-print-ovly'>
							...
							<table  class="table table-view table-hover table-responsive"> 
								...
								<tr><th>
									Home work Session </td> <td>
								$session - $sessionS
								</td> </tr> 
								
								<tr><th>
									Target Class </td> <td>
								$homeworkLevel $class </td> </tr> 
								
								<tr><th>
									Home work Term</td> <td>
								$eTerm</td> </tr>
								
								
								<tr><th>
									Home work Title </td> <td>
								$eTitle</td> </tr>
...
IGWEZE;
			...
			}elseif ($_REQUEST['homework'] == 'edit') {  /* edit homework */
				...
				if ($eID == ""){
					...
					echo "<script type='text/javascript'> hidePageLoader(); </script>";exit;
		 			...
		 			try {						
						...
						$status = $onlineHomeWorkInfoArr[$fiVal]["status"];
						//$eDetail = htmlspecialchars_decode($onlineHomeWorkInfoArr[$fiVal]["eDetail"]);							
				
?>
						<!-- form -->
						<form class="form-horizontal" id="frmupdateHomeWork" role="form">
							...
							<div class="row gutters">
								<div class="col-12">										
									...
									<div class="field-wrapper select-wrapper">
										...
										<input type="hidden" value="update" name = "homework"/>
							...
							<div class="form-group">
								<label for="eDetail" class="col-lg-4 col-sm-4 control-label"> * Home work Instruction/s</label>
								
								<div class="col-lg-8">
								
									<textarea rows="4" cols="10" class="form-control" name="eDetail" id="eDetail" 
									placeholder="Enter Home work Instructions"><?php echo $eDetail; ?></textarea>
							...
							<div class="row gutters modal-btn-footer">
								...
								<div class="col-6 text-end">
									...
									btn-label waves-light" id="updateHomeWork">
