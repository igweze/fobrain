...
if(!session_id()){
    session_start();
		...
		|| ($_SESSION['accessGrade'] != $hm_fobrain_grd)
		|| (!isset($_SESSION['accessLevel']))
		|| ($_SESSION['accessLevel'] != $hm_fob_tagged)
		...
		try { 
            ...
            if($can_use_search == true){ 
			    $activeStudent = activeStudent($conn);  /* students token record information  */
            } 
