			...
			<table class='table table-hover table-responsive style-table wiz-table'>			
                ...
                <?php 
                    ...
                    try {
                        ...
                        $ebele_mark = "SELECT l_id, staff, l_type, l_apply, l_date, status
                                    ...
                                    <td>   
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-lg-end p-10 dropdown-shadow end-0 animate__animated animate__flipInY"> 
                                                <p class="mb-10">
                                                    <a href='javascript:;' id='$staff' class ='view-staff-i text-sienna btn waves-effect btn-label waves-light'>									
                                                        <i class="mdi mdi-text-box-search label-icon"></i> View Staff
                                                    </a>	
                                                </p> 
                                                <p>
                                                    <a href='javascript:;' id='$status(-)$l_id' class ='leave-app text-slateblue btn waves-effect btn-label waves-light'>									
                                                        <i class="mdi mdi-square-edit-outline label-icon"></i> Take Action
                                                    </a>	
                                                </p> 
                                            </div>
                                        </div>    
