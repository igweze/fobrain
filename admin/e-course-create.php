...
?>
			<div id="msg-box"></div> 
			<!-- form -->
			<form class="form-horizontal" id="frmsaveCourse" role="form">			
				...
				<div class="row gutters">
					<div class="col-12">										
						...
						<div class="field-wrapper select-wrapper">
							...
							<input type="hidden" value="save" name = "course"/>
				...
				<div class="row gutters">
					<div class="col-12">										
						...
						<div class="field-wrapper"> 
							...
							placeholder="Enter Course Descriptions"></textarea>									 
				...
				<div class="row gutters mt-30">
					<div class="col-12 text-end"> 
						...
						btn-label waves-light courses-list-btn" id="saveCourse">
