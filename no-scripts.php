...
/* 
	...
	-------- Script Description --------
	This script handle No Scripts page
	------------------------------------------------------------------------*/
...
<!doctype html>
    ...
    <title>No Scripts Error | FoBrain </title>   
	<!-- stylesheet -->  
	<!-- fobrain style css -->
	...
	<body class="info-wrapper"> 
		<div class="info-screen">
			<h1>NOS</h1>
			<h5>Ooops, you need to turn on your javascript in your web browser to access this web application.</h5>
			<a href="javascript:;" onclick='window.history.go(-1); return false;' class="btn stripes-btn">Go Back</a>
		</div> 
