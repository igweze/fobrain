...
$bookInfo =<<<IGWEZE
					...
					<div class="row gutters mt-10 mb-20"> 
						<div class="col-12 text-center">
							<h4 class="font-head-1 text-danger fw-500">Certify Return Book</h4>	
						</div>									 
					</div>	
					<!-- /row --> 
					...
					<div class="slide-div">  
						...
						<div class="row gutters  mt-30"> 
							<div class="col-12">										
								...
								<div class="field-wrapper">                                                            
									...
									<div class="field-placeholder"> Comments  ? <span class="text-danger"> Optional </span></div>										 
								</div>
								<!-- field wrapper end -->
							</div>									 
						</div>	
						...
						<div class="row gutters  mt-30 mb-30"> 
							<div class="col-12 text-end">										
								<button class="btn btn-primary btn-label waves-light certyfy-book-return"
								id="$applyID-$schoolID-$lib_user">
									<i class="mdi mdi-book-edit-outline label-icon"></i> 
									Certify Book
								</button> 
							</div>									 
						</div>	
