...
if(!session_id()){
    session_start();
        ...
        || ($_SESSION['accessGrade'] != $lib_fobrain_grd)
        || (!isset($_SESSION['accessLevel']))
        || ($_SESSION['accessLevel'] != $lib_fob_tagged)
                ...
                <div data-simplebar class="h-100"> 
                    ...
                    <div id="sidebar-menu"> 
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu"> 
							...
							<li class="wiz-menu">
							    <a href="javascript:;" id="library-config" >
								    <i class="mdi mdi-book-open-variant"></i>
								    <span>Library Config.</span>
							    </a>
							</li>
                            ...
                            <li class="wiz-menu">
							    <a href="javascript:;" id="manage-books" >
                            ...
                            <li class="wiz-menu">
							  <a href="javascript:;" id="approved-books" >
