...
if(!session_id()){
    session_start();
		...
		if ($_REQUEST['query'] == 'load') {  /* load examination module */
						...
						<div class="row gutters text-center">
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6 mb-20">
								<button type="button" class="btn btn-outline-danger waves-effect waves-light w-sm">
									<i class="mdi mdi-book-education-outline d-block font-size-20"></i> $examLevel 
								</button>
							</div> 						 
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6 mb-20">
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6 mb-20">
								<button type="button" class="examPage btn btn-outline-primary waves-effect waves-light w-sm">
									<i class="mdi mdi-step-backward d-block font-size-20"></i> Go Back
								</button>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6 mb-20">
								<button type="button" id="fobrain-$eID" class="start-exam btn btn-outline-success waves-effect waves-light w-sm">
...
IGWEZE;
		...
		}elseif ($_REQUEST['query'] == 'start') {  /* start examination question */			
			...
			if ($eID == ""){
				...
				if($examQuestionsCount >= $fiVal){  /* check array is empty */			
					...
					$examSeconds =	($eTime * 60); $qNo = 0; $optNo = 0; $questionDiv = "";
					...
					for($i = $fiVal; $i <= $examQuestionsCount; $i++){  /* loop array */	
						...
						$q1 = htmlspecialchars_decode($examQuestionsArr[$i]["q1"]);
						$q2 = htmlspecialchars_decode($examQuestionsArr[$i]["q2"]);
						$q3 = htmlspecialchars_decode($examQuestionsArr[$i]["q3"]);
						$q4 = htmlspecialchars_decode($examQuestionsArr[$i]["q4"]);
						$ans = htmlspecialchars_decode($examQuestionsArr[$i]["ans"]); 
...
$questNum =<<<IGWEZE
                        	...
                        	<button class="eBtn btn btn-light examQuestNum" id="eQNo-$qNo" type="button">$qNo</button>
...
$questDiv =<<<IGWEZE
						<div class="question-$qNo" id="question-$qNo">	  
							...
							<h4> <i class="fa fa-question-circle"></i> Question <b><i>$qNo</i></b> of $examQuestionsCount  <b><i>($qMarkDiv)</i></b>  </h4>
...
$examSummary =<<<IGWEZE
						...
						<table class="table table-hover style-table display-none" id="examSummary">
                              <tbody>
								...
								<tr>								
                                    <td class="text-left text-info" style="padding-left:5% !important"> <strong>Exam Performance</strong> </td>                                    
                                </tr> 
                                ...
                                <tr>
									...
									<span class="text-success"><strong>$examQuestionsCount</strong></span> questions correctly! </td>                                    
                                </tr> 
								...
								<tr>
									...
									<strong><span id="examScore" class="text-success"></span></strong> Marks 
						...
						<div id="msg-box-e"></div>
							<input type="hidden" name = "examID" id = "examID" value= "$eID">
							<input type="hidden" name = "quesno" id = "quesno" value= "$examQuestionsCount">
				...
				<div class="col-lg-8">
					...
					<div class="card card-exam">
						...
						<div class="card-body card-body-exam"> 
							...
							<div class="display-none reviewExam pull-right my-10">
								<button type="button" class="btn btn-primary waves-effect btn-label waves-light btn-d-" id="reviewExam">
								<i class="mdi mdi-list-status label-icon"></i> Review </button>
							</div>
						
							<div class="examQuestionDiv" id="examQuestionDiv">
								<div class="examQuestDiv card-shadow py-20 px-15">
		...
		<script type="text/javascript"> 
			...
			$(document).ready(function(){
				...
				$("#reviewExam").click(function(){ /* review exam question */
					...
					$("#examQuestionDiv").slideDown(1800); //, #ansDescTB
				...
				function examFinished(){  /* execute this function when exam elapsed */
					...
					$('#msg-box-e').load('e-exam-review.php', {'query': postVal, 'eid': eid, 'correct': correctAnswer, 'quesno': quesno,
															'yscore': studentScore, 'tscore': examScore, 'aver': scorePercent });	
