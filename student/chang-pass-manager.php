      	...
      	if($_REQUEST['studentPass'] = 'changePass') {	 
			...
			/* script validation */ 
 			...
 			try { 
				...
				if ($old_pass == '') {
				...
				}elseif (!password_verify($old_pass, $retrieve_pass)) {	
					...
					if ($igweze_prep->execute()) {  /* if sucessfully */ 
						...
						$msg_s = "Your password was sucessfully change. Thanks";
						echo $succesMsg.$msg_s.$sEnd; 
						echo "<script type='text/javascript'> hidePageLoader(); </script>";	exit;						 
						 
					}else{  /* display error */ 
						 
						$msg_e = "Ooops, your password was not change, please try again";
						echo $errorMsg.$msg_e.$eEnd; 
						echo "<script type='text/javascript'> hidePageLoader(); </script>";				
						exit; 
