                    ...
                    <div class="d-flex">  
						...
						<div class="dropdown-center">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true"  data-bs-auto-close="true" aria-expanded="false">
                                ...
                                <i class="mdi mdi-cart-variant" data-title="FoBrain Page Tour" data-intro="Your Shopping Cart 👋"></i>							
                ...
                <div data-simplebar class="h-100"> 
                    ...
                    <div id="sidebar-menu"> 
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu"> 
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
									...
									<li class="wiz-menu">
                                        <a  href="javascript:;" id="e-exam-review">
											<i class="mdi mdi-chevron-right"></i>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li class="wiz-menu">
                                        <a href="javascript:;" id="e-homework">
											<i class="mdi mdi-chevron-right"></i>
                                            <span>View Home work </span>
                                        </a>
                                    </li>
									
									<li class="wiz-menu">
                                        <a  href="javascript:;" id="e-homework-review">
											<i class="mdi mdi-chevron-right"></i>
                                            <span>My Results</span>
                                        </a>
                                    </li> 
							...
							<li class="wiz-menu">
								<a href="javascript:;" id="wall-comp" >
									...
									<span id="CompanionWall">e Companion </span>
                        ...
                        <div class="side-menu-footer mt-30">
                            ...
                            <h6 class="font-head-1a mt-40"> c fobrain 2024</h6> 
                        </div>  
                    </div>
                    <!-- / sidebar -->
                </div>
