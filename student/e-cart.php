					...
					$cart_box .=  '<li> 
						<div class="row align-items-center">
							...
							<div class="col-auto">	
								...
								<a href="javascript:;" class="remove-item icon-red cart-t-btn hide-resq" data-code="'.$product["code"].'"><i class="fa fa-times fs-14"></i></a>
								<a href="javascript:;" class="editProduct icon-tem-color cart-t-btn hide-resq" id="fobrain-'.$pID.'-'.$product["qty"].'"><i class="fa fa-edit fs-14"></i></a>
