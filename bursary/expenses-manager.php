			...
			if ($pid == "")  {
				...
				if(is_array($expenseArr)){ 
                    ...
                    foreach ($expenseArr as $input_row) { 
                        ...
                        $grandtotal = (intval($grandtotal) + intval($amount));
					...
					try { 
						...
						if (($igweze_prep == true) && ($igweze_prep_1 == true) 
							...
							$msg_s = "Journal Entry  & Expenses details was successfully saved and posted"; 
							echo $succesMsg.$msg_s.$sEnd; 

							if($querytp == 2){
								$load_url = "$('#modal-load-div').load('expense-create.php', {'query': postVal, 'querytp': 2});
											//$('#load-journal-div').load('journal-chart-info.php');";
							}else{
								$load_url = "$('#modal-load-div').load('expense-create.php', {'query': postVal});
							...
							echo "<script type='text/javascript'>  
									...
									var postVal = 'add';
									$load_url
									//$('#modal-load-div').load('expense-create.php', {'query': postVal});	
									//$('#load-expenditure').load('expense-info.php');
							...
							$msg_e =  "Ooops, an error has occur while to post Journal Entry and save Expenses details. Please try again";
