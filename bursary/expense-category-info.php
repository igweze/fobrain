        ...
        <?php
						...
						if($expenseCategoryDataCount >= $fiVal){  /* check array is empty */
								...
								for($i = $fiVal; $i <= $expenseCategoryDataCount; $i++){	/* start loop */
									...
									$status = $expenseCategoryDataArr[$i]["status"];
										...
										<td>
											<div class="btn-group">
												...
												<div class="dropdown-menu dropdown-menu-lg-end p-10 dropdown-shadow end-0 animate__animated animate__flipInY"> 
													...
													<p class="mb-10">
														<a href='javascript:;' id='$eID' class ='edit-expense-category text-slateblue btn waves-effect btn-label waves-light'>									
															<i class="mdi mdi-square-edit-outline label-icon"></i> Edit
														</a>	
													</p>
													<p>
														<a href='javascript:;' id='fobrain-$eID-$expenseCategory' class ='remove-expense-category text-danger btn waves-effect btn-label waves-light demo-disenable'>									
