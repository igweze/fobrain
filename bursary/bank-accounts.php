...
$bankAccountFormBot =<<<IGWEZE
					...
					<div class="row gutters modal-btn-footer">
						...
						<div class="col-6 text-end">
							...
							btn-label waves-light demo-disenable" id="update-bankacc">
				...
				<form class="form-horizontal mt-10" id="frmsave-bankacc"> 
					...
					<div class="row gutters">
						<div class="col-12">										
							<!-- field wrapper start -->
							<div class="field-wrapper">
								<input type="text"  id="acc" name="acc"  class="form-control"  required style="text-transform:Capitalize;">
								<div class="field-placeholder">Account Name<span class="text-danger">*</span></div>													
							</div>
							<!-- field wrapper end -->
						</div>									 
					...
					<div class="row gutters modal-btn-footer">
						...
						<div class="col-6 text-end">
							...
							<button type="submit" class="btn btn-primary waves-effect   
							btn-label waves-light demo-disenable" id="save-bankacc">
