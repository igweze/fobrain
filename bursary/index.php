...
/* 
    ...
    if(!session_id()){
        ...
        || ($_SESSION['accessGrade'] != $bus_fobrain_grd)
        || (!isset($_SESSION['accessLevel']))
        || ($_SESSION['accessLevel'] != $bus_fob_tagged)
        ...
        try {   
            ...
            list ($title, $staffName, $staffSex, $staff_fobrain_grdQ, $staffPic, $staffLName) = 
            explode ("#@s@#", $staffInfo);	            
            $titleVal = wizSelectArray($title, $title_list);
            $staff_t_name  = $titleVal.' '.$staffLName; 
            $staff_img = picture($staff_pic_ext, $staffPic, "staff");
            ...
            <header id="page-topbar">			
                <div class="navbar-header">				
                    ...
                    <div class="d-flex">  
                        ...
                        <div class="dropdown-center"  data-title="FoBrain Page Tour" data-intro="Change to your prefered language here 👋">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu"> 
                            ...
                            <li class="">
                                ...
                                <ul class="sub-menu" aria-expanded="false">      
                                    <!--
                                    <li class="wiz-menu">
                                        <a  href="javascript:;" id="bank-accounts">
                                    ...
                                    <li class="wiz-menu">
                                        <a  href="javascript:;" id="burs-config">
											<i class="mdi mdi-chevron-right"></i>
                                            <span>Bursary Config.</span>
                                        </a>
                                    </li>

                                    <li class="wiz-menu">
                                        <a  href="javascript:;" id="chart-accounts">
											<i class="mdi mdi-chevron-right"></i>
                                    ...
                                    <li class="wiz-menu">
                                        <a  href="javascript:;" id="fee-category">
											<i class="mdi mdi-chevron-right"></i>
                                    ...
                                    <li class="wiz-menu">
                                        <a  href="javascript:;" id="expense-category">
											<i class="mdi mdi-chevron-right"></i>
                                    ...
                                    <li class="wiz-menu">
                                        <a  href="javascript:;" id="product-category">
											<i class="mdi mdi-chevron-right"></i>
                            ...
                            <li class="wiz-menu">
							  <a href="javascript:;" id="journal-chart" >
                            ...
                            <!--        
                            <li class="wiz-menu">
							  <a href="javascript:;" id="trial-balance" >
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">     
                                    ...
                                    <li class="wiz-menu"><a  href="javascript:;" id="parent-meeting">
                                        <i class="mdi mdi-chevron-right"></i> Parent Meeting</a>
                                    </li>
                                    <li class="wiz-menu"><a  href="javascript:;" id="staff-meeting">
							...
							<li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">     
                                    <li class="wiz-menu"><a  href="javascript:;" id="my-profile">
                                        <i class="mdi mdi-chevron-right"></i> Profile</a>
                                    </li> 
                                    <li class="wiz-menu"><a  href="javascript:;" id="my-payroll">
                                        <i class="mdi mdi-chevron-right"></i>  Payroll </a>
                                    </li> 
                                    <li class="wiz-menu"><a  href="javascript:;" id="my-leave">
                                        <i class="mdi mdi-chevron-right"></i>  Staff Leave</a>
                                    </li> 
                                    <li class="wiz-menu"><a  href="javascript:;" id="access">
                                        <i class="mdi mdi-chevron-right"></i>  Change Password</a>
                                    </li>                                      
                                </ul>
                            </li>
