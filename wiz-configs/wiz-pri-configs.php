...
/* 
	...
	------------------------------------------------------------------------*/
		...
		try {
			...
			$configFourF = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $foVal, $fiVal); /* first term subjects array */
			$configFourS = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $foVal, $seVal); /* second term subjects array */
			$configFourT = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $foVal, $thVal); /* third term subjects array */
		...
		$query_select_class_four_fi_term = "";
		$query_select_class_four_fi_term_to = "";
		$query_select_class_four_fi_term_po = "";
		$query_select_class_four_fi_term_com = "";
		...
		$query_select_class_four_se_term = "";
		$query_select_class_four_se_term_to = "";
		$query_select_class_four_se_term_po = "";
		$query_select_class_four_se_term_com = "";
		...
		$query_select_class_four_th_term = "";
		$query_select_class_four_th_term_to = "";
		$query_select_class_four_th_term_po = "";
		$query_select_class_four_th_term_com = "";
		...
		try {
			...
			$configFiveF = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $fifVal, $fiVal); /* first term subjects array */
			$configFiveS = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $fifVal, $seVal); /* second term subjects array */
			$configFiveT = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $fifVal, $thVal); /* third term subjects array */
		...
		$query_select_class_five_fi_term = "";
		$query_select_class_five_fi_term_to = "";
		$query_select_class_five_fi_term_po = "";
		$query_select_class_five_fi_term_com = "";
		...
		$query_select_class_five_se_term = "";
		$query_select_class_five_se_term_to = "";
		$query_select_class_five_se_term_po = "";
		$query_select_class_five_se_term_com = "";
		...
		$query_select_class_five_th_term = "";
		$query_select_class_five_th_term_to = "";
		$query_select_class_five_th_term_po = "";
		$query_select_class_five_th_term_com = "";
		...
		try {
			...
			$configSixF = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $sixVal, $fiVal); /* first term subjects array */
			$configSixS = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $sixVal, $seVal); /* second term subjects array */
			$configSixT = fobrainSchoolCoursesData($conn, $fobrainConfigTB, $schoolID, $sixVal, $thVal); /* third term subjects array */
		...
		$query_select_class_six_fi_term = "";
		$query_select_class_six_fi_term_to = "";
		$query_select_class_six_fi_term_po = "";
		$query_select_class_six_fi_term_com = "";
		...
		$query_select_class_six_se_term = "";
		$query_select_class_six_se_term_to = "";
		$query_select_class_six_se_term_po = "";
		$query_select_class_six_se_term_com = "";
		...
		$query_select_class_six_th_term = "";
		$query_select_class_six_th_term_to = "";
		$query_select_class_six_th_term_po = "";
		$query_select_class_six_th_term_com = "";
