...
/* 
	...
	------------------------------------------------------------------------*/ 
			...
			$rsCommentSpan = $rsColplus + 7;	
			
			$fobrainSchTitle ="<h2 class='text-theme-blue'>  $schoolNameTop </h2> 
...
$table_body =<<<IGWEZE
			...
			<table class="table table-sm table-hover table-responsive">
				<thead>
					<tr>
						<th width="1%" rowspan="2" class="hide-resps"><span class="vertical-lr rotated">S/N</span></th>
						<th width="20%" rowspan="2">Subjects</th>
						$csCHRow 
						<th rowspan="2"><span class="vertical-lr rotated">Exam  ($exam_score) </span> </th>
						<th rowspan="2"><span class="vertical-lr rotated">Total Score</span></th>
						<th rowspan="2"><span class="vertical-lr rotated">Grade</span></th>
						<th rowspan="2" class="hide-resps"><span class="vertical-lr rotated">Remarks</span></th>
						<th rowspan="2" class="hide-resps">Teacher  Comments </th>
						<th rowspan="2" class="hide-resps">Teachers Name</th>
					</tr>
					$csCLRow  	
				</thead>
				<tbody>
...
IGWEZE;
			...
			for ($i = $i_start_loop; $i <= $i_stop_loop; $i++) {  /* loop array */
				...
				$courseCount++;
				echo "<tr>
						<td valign='middle' class='hide-resps'>$courseCount</td> 
						<td class='v-align font-head-1-out fs-13 text-primary fw-500'>"; 
						echo $course_info_mark[$subArr][2];
						echo "</td>";
						echo  $examRows;
						echo  $i_score_gr;
						echo "</td><td class='v-align hide-resps'>";
						echo  $score_remarks;
						echo "</td><td style='text-align:justify !important;' 
						class='v-align hide-resps  text-primary  font-head-1 fs-14'> $subjectComment </td>
						<td style='width='30%' class='v-align hide-resps font-head-1 fs-12 text-primary fw-500'> $sub_staff_name </td>
					</tr>";
					
					echo "<tr class='no-hide-resps hide'>";  
					echo "<td style='text-align:justify !important;'  colspan='$rsCommentSpan'
					class='v-align text-primary fw-600  font-head-1 fs-14' > $subjectComment </td>
				</tr>";
			...
			echo"  	<tr>
						<th style='text-align:right !important; padding-right:10px;'  colspan='2'>
							<span class ='hide-res'>Number Of</span> Subjects : 
						</th>
						<td colspan='1' class ='text-primary font-head-1 fw-600'>$courseNum</td>
						<th style='text-align:right !important; padding-right:10px;' colspan='3'>
							Total Score :
						</th>
						<td colspan='1' class = 'text-primary font-head-1 fw-600'> $total_score </td>
						<th style='text-align:left !important; padding-left:50px;' colspan='3'>
							<span class ='hide-res'>Student</span> Average : 
							<span class='text-primary font-head-1 fw-600'>$student_avg<span>
						</th> 
						</tr>
					</tbody>";		
				...
				<div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12">  
					<table width="100%" class="table table-sm mt-20">
						...
						<tr style="border-color:#fff;">
							<td colspan="2"  style="border-bottom-color : #000;">No of Students in Class : 
