...
?>		
					...
					<div class="card-body">
						 ...
						 <div class="row gutters my-15"> 
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12 text-end">
								<button type="button" class="add-payment btn btn-primary waves-effect   
						...
						<div id="load-payment-info" class="mt-20 pb-50"> 
							<?php require 'payment-info.php';  ?> 
						</div> 
					</div><!-- end card-body -->	
				</div>
				<!-- card end -->	
		...
		<!-- Scrollable modal modal-lg modal-fullscreen-lg-down -->
		...
		<script type="text/javascript">
			...
			function expenseRange(){   /* fee  date range */													
				...
				$('#load-payment-info').load('payment-info.php', {'search': postVal, 'search-to': end, 
					'search-from': start});					
