...
/* 
	...
	die('Hahahaha, Hacking attempt . . . . Be Careful . . . . You Are Been Warned !!!!');
		...
		<select class='form-control fob-selecta'  id='bank_acc' name='bank_acc'>";
		try {
		
			$options .= expenseOptions($conn, $expID, 1);
		...
		*/
		...
		try {
			...
			$options = "<select class='form-control'  id='expense-cate' name='expense-cate'>".expenseOptions($conn, $expID = "", 1)."</select>";
...
?>                 
		...
		<div class="row gutters">	    
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">										
				<!-- field wrapper start -->
				<div class="field-wrapper">
					<input type="date"  name="edate" id="edate" class="chart-autofill"  data-code="journal-date" />
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">										
				<!-- field wrapper start -->
				<div class="field-wrapper">
					<select class="form-control fob-select"  id="method" name="method">
		...
		<div class="row gutters">
			...
			<div class="col-10 text-end text-primary" style="position:relative; top:-50px;">
				Grand Total - <?php echo $curSymbol ?> <span id="divGrandTotal" class="ms-10q"></span>  
			</div>
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">										
				...
				<div class="field-wrapper">
					...
					value="furniture" autocomplete="off" placeholder="Enter expense tags " />
			...
			<div class="col-12 mt-30">	 
				<div class="row">	 
					...
					<div class="col-6 text-end">										
						...
						<form id="frmExpenseUpload" method="post" enctype="multipart/form-data"> 
							...
							<label class="upload upload-expense-div">
				...
				<div class="row mt-10"> 
					...
					<di class="doc-upload-holder">  		
						<div id="preview-upload" class="col-lg-12"></div>	 
					</div> 
		...
		<div class="row gutters modal-btn-footer">
			...
			<div class="col-6 text-end">
				<input type="hidden" name="querytp" id="querytp" value="<?php echo $querytp; ?>" />
				<button type="submit" class="btn btn-primary waves-effect   
				btn-label waves-light demo-disenable"  onclick='saveExpense()'>
		...
		<script type="text/javascript"> 
			...
			$(function() {
				...
				$("#add-row").click(function(){
					...
					var table = "<tr>"
							...
							+ "<td><input type='number' class='tr-qty form-control input-bk-qty' onkeyup='calculateTotal()'></td>"
				...
				$(document).on("change", ".tr-total", function() {
					...
					$("#divGrandTotal").html(sum);
					$(".journal-amount").val(sum);
				});
			...
			function calculateTotal() {
				...
				$('#fob-calculate-tb > tbody  > tr').each(function() {
					...
					if (isNaN( price )) { 
						...
						Swal.fire(
							'Invalid Iinput!',
							'Invalid Rate input. Enter number or float only eg 3000, 3500.08.',
							'error'
						);
						
						$(this).find('.tr-rate').val("");
						return false; 
			...
			function saveExpense(){   
				...
				$.ajax('expenses-manager.php', {
					type: 'POST',  					
					data: { query:query, pid:pid, title:title, inputs:input_arr, journals:journal_arr, payee:payee, edate:edate, method:method, tags:tags, memo:memo, querytp:querytp},
					success: function (data, status, xhr) {
						$('#msg-box-mo').html(data);
					},
					error: function (jqXhr, textStatus, errorMessage) {
						$('#msg-box-mo').html('Error: ' + errorMessage);
					}
				}); 
