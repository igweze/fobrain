				...
				<div class="card card-shadow"> 
					...
					<div class="card-body">
						...
						<div class="gutters my-15 text-end"> 
							<button type="button" class="add-acc-c btn btn-primary waves-effect me-10  
							btn-label waves-light" id="wiz-1">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Add Bank
							</button> 
						</div>
						<!-- /row -->	  
						<div id="load-acc-category" class="pb-30"> 
							<?php require 'bank-accounts-info.php';  ?> 
						</div> 
					</div><!-- end card-body -->	
				</div>
				<!-- card end -->	
