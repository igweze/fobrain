...
?>
		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div justify-content-center">
			<div class="col-12">	
				...
				<div class="card card-shadow"> 
					<?php 
						$page_title = '<i class="mdi mdi-chart-areaspline fs-18"></i> 
							School Expenses';
					...
					<div class="card-body"> 
						...
						<div class="row gutters my-15"> 
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12 text-end">
								<button type="button" class="add-expense btn btn-primary waves-effect   
						...
						<div id="load-expenditure" class="mt-20 pb-50"> 
							<?php require 'expense-info.php';  ?> 
						</div>
					</div><!-- end card-body -->	
				</div>
				<!-- card end -->	
				...
				<div class="modal-content"> 
					<div class="modal-header"> 
						<h5 class="modal-title" id="exampleModalScrollableTitle"> 
							<i class="mdi mdi-chart-areaspline label-icon"></i>  
							Expenses Manager
						</h5>									 
		...
		<script type="text/javascript">
			...
			function searchRange(){   /* expense date range */
				...
				$('#load-expenditure').load('expense-info.php', {'search': postVal, 'search-to': end, 
					'search-from': start});					
