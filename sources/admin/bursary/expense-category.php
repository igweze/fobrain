		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div justify-content-center">
			<div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">	
				...
				<div class="card card-shadow"> 
					<?php 
						$page_title = '<i class="mdi mdi-clipboard-flow-outline fs-18"></i> 
							School Expenses Category';
					...
					<div class="card-body"> 
						...
						<div class="gutters my-15 text-end"> 
							<button type="button" class="add-expense-c btn btn-primary waves-effect   
							btn-label waves-light" id="wiz-1">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Add
							</button>
						</div>
						<!-- /row --> 
						<div id="load-expense-category" class="pb-30"> 
							<?php require 'expense-category-info.php';  ?> 
						</div> 
					</div><!-- end card-body -->	
				</div>
				<!-- card end -->	
				...
				<div class="modal-content"> 
					<div class="modal-header"> 
						<h5 class="modal-title" id="exampleModalScrollableTitle"> 
							<i class="mdi mdi-clipboard-flow-outline label-icon"></i>  
							Expenses Category
						</h5>									 
