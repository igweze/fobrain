...
if(!session_id()){
    session_start();
		...
		//if (($_SESSION['accessGrade'] != $cm_fobrain_grd)) { 
...
?>
		...
		<!-- row -->
		<div <?php echo $fob_view; ?> class="row gutters mb-40 justify-content-center">
		...
		<!-- row -->
		<div <?php echo $fob_view; ?> class="row gutters mb-40 justify-content-center display-none">
