		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div justify-content-center">
			<div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">	
				...
				<div class="card card-shadow"> 
					<?php 
						$page_title = '<i class="mdi mdi-store-24-hour fs-18"></i> 
					...
					<div class="card-body">
						...
						<div class="row gutters mt-10">
							<div class="col-12 text-end">
								<button type="button" class="add-product-category btn btn-dark waves-effect   
						...
						<!-- /row -->	 
						<div id="load-item-category" class="pb-30"> 
							<?php require 'item-category-info.php';  ?> 
						</div> 						
					</div><!-- end card-body -->	
				</div>
				<!-- card end -->	
				...
				<div class="modal-content"> 
					<div class="modal-header"> 
						<h5 class="modal-title" id="exampleModalScrollableTitle"> 
							<i class="mdi mdi-store-24-hour label-icon"></i>  
							Product Item Category Manager
						</h5>									 
