...
?> 				
			...
			<div class="col-lg-12">	
				...
				<div class="card card-shadow">
					<div class="card-header-wiz"> 
						<h4> 
							<span class="head-homework">
								<i class="mdi mdi-google-classroom fs-18"></i> 
								Online Home work Manager
							</span> 
						...
						<div class="row gutters  justify-content-center">
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12  card-shadow py-30  load-wiz-frm  display-none">	
								<div class="hints my-30">
									...
									Create new and manage new home work below.
								</div>
								<div id="load-wiz-frm"> <?php require 'e-homework-create.php';  ?> </div>
							</div>

							<div class="col-12 card-shadow py-30 new-homework-div  display-none">	
								<div class="hints my-30">
									[<i class="mdi mdi-help-circle-outline"></i>] 
									Create new and manage new home work below.
								</div>
								<div id="new-homework-div">  </div>
							</div>
			...
			<div class="modal-dialog modal-fullscreen-sm-down modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header"> 
						<h5 class="modal-title" id="homeworkpleModalScrollableTitle"> 
		...
		<script>
			...
			$('body').on('click','.view-info-div',function(event){  /* view info div */
				...
				$('.view-info-div, .load-wiz-frm, .new-homework-div').fadeOut(1000); 
			...
			$('body').on('click','.add-new-div',function(event){  /* view add new div*/
				...
				$('.add-new-div, #load-wiz-info, .new-homework-div').fadeOut(1000); 
				$('#load-wiz-frm').load('e-homework-create.php');
