						...
						<form class="form-horizontal" id="frmsearch-session-rs" role="form">
							<div class="row gutters mb-25 mt-10">
								<div class="hints">
									...
									Search class result to view, edit etcs
								</div>
							</div>

							<?php $show_all = 1; require ($fobrainAdminGlobalDir.'common-frm-1.php'); ?> 
							...
							<div class="row gutters">
								<div class="col-lg-12">										
									...
									<div class="field-wrapper">
										<select class="form-control fob-select"  id="term1" name="term" required>
											...
											?>
												<option value="annual">All Term</option>
				...
				<div class="modal-content"> 
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalScrollableTitle"> 
							<i class="mdi mdi-format-list-checks label-icon"></i>  
							Result Manager
						</h5>
