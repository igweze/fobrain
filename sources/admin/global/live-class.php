...
/* 
	...
	-------- Script Description --------
	This page load online live class information
	------------------------------------------------------------------------*/ 
		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div justify-content-center">
			<div class="col-lg-12">	
				...
				<div class="card card-shadow"> 
					...
					?>
					<div id="msg-box"></div> 					
					<div class="card-body" id="liveclassQuestDiv"> 

						<div class="row gutters mb-25 mt-10">
                            <div class="hints">
								[<i class="mdi mdi-help-circle-outline"></i>] 
								Only Class or Subject Managers can create and manage a live class. Super Admin or HM can join this classes. 
							</div>
                        </div>
						<div class="gutters my-15 text-end">  
							<button type="button" class="add-liveclass live_component btn btn-primary" id="fob-1">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Create  
							</button> 
							
						</div> 
						<div id="load-wiz-info"> <?php require 'live-class-info.php';  ?> </div> 
					</div>
				</div>
				<!-- card end -->	
			</div>
