			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">	
				...
				<div class="card card-shadow"> 
					...
					$page_title = '<i class="mdi mdi-auto-upload fs-18"></i> 
							 Upload Bulk Comment Results';
						pageTitle($page_title, 0);	 
					?>	
					<div id="msg-box"></div> 					
					<div class="card-body">   

                        <div class="gutters my-15 text-end wiz-menu"> 
							<a href="javascript:;" id="upload-results-bulk" type="button" class="btn btn-primary" >
								<i class="mdi mdi-cloud-upload label-icon"></i>   Bulk Result Upload
							</a> 
						</div> 
						<hr class="my-15 text-danger" />
						
						<form class="form-horizontal" id = "frmbulk-excel-com"  enctype="multipart/form-data" 
							action='bulk-com-upload.php'  method="POST" role="form">	 

							<div class="row gutters mb-25 mt-10">
								<div class="hints">
									[<i class="mdi mdi-help-circle-outline"></i>] 
									Kindly work offline and upload bulk student's comment result at once with Excel file
								</div>
							</div>
								...
								<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 text-center">
									...
									<div class="file-wrapper component-free">
										<label class="upload fob-btn-div">
											...
											<input type="file" name="uploadPic" id="bulk-excel-com" class="form-control hide">
										</label> 
