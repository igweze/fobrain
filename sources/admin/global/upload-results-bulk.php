				...
				<div class="card card-shadow"> 
					...
					<div class="card-body">   
						...
						<div class="gutters my-15 text-end wiz-menu">  
							<a href="javascript:;" id="upload-com-bulk" type="button" class="btn btn-dark">
								<i class="mdi mdi-upload-multiple label-icon"></i> Bulk  Comment Upload 
							</a>  
						</div> 
						<hr class="my-15 text-danger" />
						
						<form class="form-horizontal" id = "frmbulk-excel-result"  enctype="multipart/form-data" 
								...
								<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 text-center">
									...
									<div class="file-wrapper component-free">
										<label class="upload fob-btn-div">
											...
											<input type="file" name="uploadPic" id="bulk-excel-result" class="form-control hide">
										</label> 
