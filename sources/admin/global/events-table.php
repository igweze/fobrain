				...
				<div class="card card-shadow"> 
					...
					<div class="card-body"> 
						...
						<div class="gutters my-15 text-end"> 
							<button type="button" class="create-event btn btn-primary waves-effect   
							btn-label waves-light" id="load">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Add
							</button>
						</div> 
						<?php } ?>
						<div id="load-wiz-info"> <?php require 'events-info.php';  ?> </div>
					</div>
				</div>
				<!-- card end -->	
			</div>
				...
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalScrollableTitle">
							<i class="mdi mdi-calendar-multiple label-icon"></i> 
							School Event
						</h5> 				 
