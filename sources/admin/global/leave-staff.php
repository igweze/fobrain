				...
				<div class="card card-shadow"> 
					...
					<div class="card-body">  
						<div class="gutters my-15 text-end"> 
							<button type="button" class="add-leave-staff btn btn-dark waves-effect   
							btn-label waves-light" id="load">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Apply
							</button>
						</div> 
						<div id="load-wiz-info"> <?php require 'leave-info-staff.php';  ?> </div>
					</div>
				</div>
				<!-- card end -->	
			</div>
