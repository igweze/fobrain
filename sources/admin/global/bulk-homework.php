			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">	
				...
				<div class="card card-shadow"> 
					...
					$page_title = '<i class="mdi mdi-auto-upload fs-18"></i> 
						 	Upload Bulk Homework & Questions';
					...
					<div class="card-body"> 
						...
						<div class="gutters my-15 text-end ">  
							<span = class="wiz-menu"> 
								<a href="javascript:;" id="e-homework" class="btn btn-primary"> 
									<i class="mdi mdi-notebook-plus-outline label-icon"></i>  View  Homework  
								</a>
							</span> 
						</div> 
						...
						<form class="form-horizontal" id = "frmbulk-excel-exam"  enctype="multipart/form-data" 
							...
							<div class="row gutters mb-25 mt-10">
								<div class="hints">
									...
									Bulk upload homework questions and answers using an Excel file. Exam questions and answers are uniquely reshuffled for each student. Suitable for JAMB, WASSCE, NECO, and others.
								</div>
							</div>
