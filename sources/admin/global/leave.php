...
/* 
	...
	-------- Script Description --------
	This page handle school staffs leave
	------------------------------------------------------------------------*/ 
		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div justify-content-center">
				...
				<div class="card card-shadow"> 
					...
					<div class="card-body"> 
						<div class="gutters my-15 text-end"> 
							<button type="button" class="create-leave btn btn-primary waves-effect   
							btn-label waves-light" id="load">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Add
							</button>
						</div> 
						<div id="load-wiz-info-cat"> <?php require 'leave-cat-info.php';  ?> </div>
					</div>
				</div>
				<!-- card end -->	
			</div>
			...
			<div class="col-lg-8 col-12">	
				...
				<div class="card card-shadow"> 
					...
					<div id="msg-box"></div> 					
					<div class="card-body">  
						<div id="load-wiz-info"> <?php require 'leave-info.php';  ?> </div>
					</div>
				</div>
				<!-- card end -->	
			</div>
