...
/* 
	...
	-------- Script Description --------
	This page load online course information
	------------------------------------------------------------------------*/ 
...
?> 				
			...
			<div class="col-lg-12">	
				...
				<div class="card card-shadow">
					<div class="card-header-wiz"> 
						<h4> 
							<span class="head-course">
								<i class="mdi mdi-google-classroom fs-18"></i> 
								Online Courses Manager
							</span> 
							<span class="head-quest display-none">
								<i class="mdi mdi-google-classroom fs-18"></i> 
								Chapter & Answer Manager
							</span>
						</h4> 
					</div> 
					<div id="msg-box"></div> 					
					<div class="card-body" id="courseQuestDiv"> 
						<div class="gutters my-15 text-end"> 
							<button type="button" class="view-info-div btn btn-dark display-none" >
								<i class="mdi mdi-text-box-search label-icon"></i>  Back to  Courses
							</button>
							<button type="button" class="add-new-div btn btn-primary">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Create  Course
							</button>  
						</div> 
						<div id="load-wiz-info"> <?php require 'e-course-info.php';  ?> </div>
						...
						<div class="row gutters justify-content-center">
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12  card-shadow py-30  load-wiz-frm  display-none">	
								<div class="hints my-30">
									...
									Create new and manage new course below.
								</div>
								<div id="load-wiz-frm"> <?php require 'e-course-create.php';  ?> </div>
							</div>

							<div class="col-12 card-shadow py-30 new-course-div  display-none">	
								<div class="hints my-30">
									[<i class="mdi mdi-help-circle-outline"></i>] 
									Create new and manage new course below.
								</div>
								<div id="new-course-div">  </div>
							</div>
			...
			<div class="modal-dialog modal-fullscreen-sm-down modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header"> 
						<h5 class="modal-title" id="coursepleModalScrollableTitle"> 
		...
		<script>
			...
			$('body').on('click','.view-info-div',function(event){  /* view info div */
				...
				$('.view-info-div, .load-wiz-frm, .new-course-div').fadeOut(1000); 
			...
			$('body').on('click','.add-new-div',function(event){  /* view add new div*/
				...
				$('.add-new-div, #load-wiz-info, .new-course-div').fadeOut(1000); 
				$('#load-wiz-frm').load('e-course-create.php');
