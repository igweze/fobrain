		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div justify-content-center">
			<div class="col-lg-7 col-12">	
				...
				<div class="card card-shadow"> 
					<?php 
						$page_title = '<i class="fas fa-brain fs-16"></i> 
					...
					<div class="card-body"> 
						<div class="gutters my-15 text-end"> 
							<button type="button" class="add-grade btn btn-primary waves-effect   
							btn-label waves-light" id="load">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Add
							</button>
						</div> 
						<div id="load-wiz-info"> <?php require 'grades-info.php';  ?> </div>
					</div>
				</div>
				<!-- card end -->	
			</div>
