...
if(!session_id()){
    session_start();
		...
		require 'fobrain-config.php';  /* load fobrain configuration files */	 
			...
			if($schoolExt == $fobrainNurAbr){ /* check if school loaded is nursery school */
            ...
            <div class="row value-box" style="margin:30px 10px 0px 0px">
				...
				<div class="col-lg-12 col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body fobrain-line"><br /> 
						...
						<script src="<?php echo $fobrainTemplate; ?>js/chartinator.js"></script>				
						<script src="<?php echo $fobrainTemplate; ?>js/chart-fobrain-config.js"></script> 
				...
				<div class="col-lg-12">
					<div class="panel">
					 ...
					 <div class="panel-heading">
                      ...
                      <div class="panel-body fobrain-line">
						...
						<br clear="all"/ > 
							...
							<div id = "bursaryChart">
									...
									<?php require_once $fobrainGlobalDir.'/busaryCharts.php'; ?>
                        ...
                        <div class="panel-body fobrain-line">
								<div class="col-lg-12">
								  <section class="panel">
									  ...
									  <div class="panel-body fobrain-linea" id="load-wiz-info">
											<!-- school annoucement start -->  
								...
								<table  class='table table-hover style-table wiz-table' id=''>
										<thead><tr>
										<th>S/N</th>                         
...
$broadcastData =<<<IGWEZE
								...
								<tr id="row-$bID" >
								<td class='text-left' width="5%">$serial_no</td>  
									...
									<div class="btn-group">
										...
										<i class="fa fa-wrench"></i> <span class="caret"></span></button>
											<ul role="menu" class="dropdown-menu pull-right"> 
													...
													<!-- <li class="divider"></li>
													<li>
													<a href='javascript:;' id='fobrain-$bID-$expenseCategory' class ='removeBroadcast'> 
...
IGWEZE;
          ...
          ?>
				...
				<div class="modal fade animate__animated animate__zoomInDown" id="removeModal" tabindex="-1" role="dialog" 
				aria-labelledby="fobrain-modalLabel" aria-hidden="true">
					<div class="modal-dialog">
					  <div class="modal-content">
						  ...
						  <div class="modal-body"> 
								...
								<center><img src="<?php echo $fobrainTemplate?>images/loading.gif" alt="Page Loading >>>>>" class="loader-img" id="removeLoader"  
						  ...
						  <div class="modal-footer display-none slideUpFrmDiv">
							  <button  class="btn btn-danger demo-disenable" id="removeBroadcast" 
				...
				<div class="modal fade animate__animated animate__zoomInDown" id="editModal" tabindex="-1" role="dialog" 
					aria-labelledby="fobrain-modalLabel" aria-hidden="true">
					<div class="modal-dialog">
					  <div class="modal-content">
						  <div class="modal-header">
						  ...
						  <div class="modal-body modal-body-scroll"> 
								...
								<center><img src="<?php echo $fobrainTemplate?>images/loading.gif" alt="Page Loading >>>>>" class="loader-img" id="editLoader"  
												  style="cursor:pointer; display:none; margin-bottom:5px;" /></center>
                ...
                <script type='text/javascript' src='<?php echo $fobrainTemplate; ?>js/css-clocks.js'></script> 
