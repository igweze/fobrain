		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div">
			<div class="col-12">	
				...
				<div class="card card-shadow"> 
					<?php 
						$page_title = '<i class="mdi mdi-credit-card-settings fs-18"></i> 
						Payment Gateway Manager';
						pageTitle($page_title, 0);	 
					?> 
					<div id="msg-box"></div> 					
					<div class="card-body">
						<div id="load-wiz-info"> <?php require 'payment-gateway-info.php';  ?> </div>
					</div>
				</div>
				<!-- card end -->	
			</div>
				...
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalScrollableTitle"> 
							<i class="mdi mdi-credit-card-settings label-icon"></i>  
							Payment Gateway Manager
						</h5>							 
