		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div justify-content-center">
			<div class="col-12">	
				...
				<div class="card card-shadow"> 
					<?php 
					$page_title = '<i class="mdi mdi-warehouse fs-18"></i> 
					...
					<div class="card-body"> 
						<div class="gutters my-15 text-end"> 
							...
							btn-label waves-light" id="load-hostel">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Add
							</button>
						</div> 
						<div id="load-wiz-info"> <?php require 'hostels-info.php';  ?> </div>
					</div>
				</div>
				<!-- card end -->	
			</div>
				...
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalScrollableTitle">
							<i class="mdi mdi-warehouse label-icon"></i> 
							School Hostel Manager
						</h5> 								 
