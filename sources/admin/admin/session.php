		...
		<div <?php echo $fob_view; ?> class="row gutters row-section fobrain-section-div justify-content-center">
			<div class="col-lg-10 col-12">	
				...
				<div class="card card-shadow"> 
					<?php 
						$page_title = '<i class="mdi mdi-progress-clock fs-18"></i>
						School Session';
					...
					<div class="card-body"> 
						<div class="gutters my-15 text-end"> 
							<button type="button" class="set-session btn btn-primary waves-effect   
							btn-label waves-light" id="wiz-1-load">
								<i class="mdi mdi-notebook-plus-outline label-icon"></i>  Set Current Session
							</button>
						</div> 
						<div id="load-wiz-info"> <?php require 'session-info.php';  ?> </div>
					</div>
				</div>
				<!-- card end -->	
			</div>
