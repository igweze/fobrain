		...
		<div class="row gutters  justify-content-center">
			<div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-12">	
				...
				<div class="card card-shadow"> 
					<?php 
						$page_title = '<i class="fas fa-user-lock fs-16"></i> 
							Change My Password';
					...
					<div id="msg-box"></div> 
						<!-- form -->
						<form class="form-horizontal" id="frm-change-pass">	
							<!-- row -->
							...
							<div class="row gutters mt-30">
								...
								<input type="hidden" name="studentPass" value="changePass" />
									<button type="submit" class="btn btn-primary waves-effect 
									 demo-disenable btn-label waves-light"  
									 id="change-pass"><i class="mdi mdi-content-save label-icon"></i> 
									Update</button> 
								</div>
							</div>	
							<!-- /row -->	
