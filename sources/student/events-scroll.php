...
?>     
		...
		<div <?php echo $fob_view; ?> class="row gutters row-section  justify-content-center">
          ...
          <?php 
						$page_title = '<i class="fas fa-calendar-day fs-16"></i> 
            School Events ';
            ...
            <div class="view-tree-div">
              ...
              <div class="event-timeline my-30">
                <span id="results">
                 <?php include('load-events.php'); ?>
                </span>
                
                <div class="pg-loader text-center  my-10" id="loader">
        ...
        $(window).scroll(function(){
          if ($(window).scrollTop() == $(document).height() - $(window).height()){
            if($(".page_number:last").val() <= $(".total_record").val()) {
              ...
              loadRecord('load-events.php?page='+pagenum);
            }
          }
        });
      });
