...
?>	
			...
			<!-- row --> 
			<div class="row gutters mb-40" data-aos="fade-up" data-aos-duration="15000">
...
IGWEZE;
          ...
          ?>           
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
					...
					<div class="card card-widget-1 card-shadow"> 
						<?php 
							$page_title = '<i class="fas fa-list-ol fs-16" data-title="FoBrain Page Tour" data-intro="Daily Attendance section 👋"></i> 
							Daily Roll Call ';
							pageTitle($page_title, 0);	 
						?>
						<div class="card-body scroll">
						...
						<div class="table-responsive pt-3">				 							
							...
							<table  class='table table-hover table-responsive style-table wiz-table'>
								...
								<tr>
									...
									<th>Date</th>						
									<th>Status</th> 
									<th>Teacher Comment/s <hr class="my-5 p-0 text-danger"/> Parent Reply</th>  
									<th>Tasks</th> 
									</tr>
								</thead> 
								<tbody>
...
$rollCall =<<<IGWEZE
									...
									<tr id="row-$rID" >
										...
										<td> $startdate </td> 
										<td> $title  </td>
										<td> $comment <hr class="my-5 p-0 text-danger"/> <span class="parent-reply-$rID">$reply</span> </td>
...
IGWEZE;
          ...
          ?>           
			...
			<div class="row mb-40 align-items-center"  data-aos="fade-up data-aos-duration="15000">	
				<div class="col-lg-4">
					<!-- card -->
					<div class="card card-widget-1 card-shadow"> 
						<?php 
